...
dataset_paths = ['dataset/itarea_compl2016_telematics_sent_clr_disc_y.csv',
...
for dataset_path in dataset_paths:
    ...
    for risk_level in risk_levels:
        ...
        SKLearn.cross_validation(dataset=dataset,
                                 ...
                                 n_cluster=n_cluster,
                                 cluster_both_class=False)



        for percentage in range(30, 101, 30):
            for n_cluster in range(6, 10, 3):
                SKLearn.cross_validation(dataset=dataset,
                                         target=target,
                                         labels=target_encoder,
                                         dataset_name = dataset_path,
