...
def txt2xls(path_name):
    ...
    for filename in onlyfiles:
        ...
        header_exel = ["Perc_Undersampling","Accuracy","Prec_T0","Rec_T0","F1_T0","Prec_T1","Rec_T1","F1_T1","AVG_Prec","AVG_Rec","AVG_F1","TP", "TN", "FP", "FN","Run_Time", "Num_Clf"]
        ...
        r1 = r1 + 1
        sh.write(r1, c1, "Num_Clf:")
        sh.write(r1, c2, "Quantita' di classificatori utilizzati")
        ...
        with open(path) as f:
            ...
            for line in lines:
                ...
                if line.__contains__("classifiers: "):
                    l_split = line.split(": ")
                    n_clf = l_split[1]
                ...
                if print_line == True:
                    ...
                    c3 = c3 + 1
                    sh.write(index_excel, c3, float("{0:.2f}".format(100*(s00 + s10)/2.0)))
                    c3 = c3 + 1
                    sh.write(index_excel, c3, float("{0:.2f}".format(100*(s01 + s11)/2.0)))
                    c3 = c3 + 1
                    sh.write(index_excel, c3, float("{0:.2f}".format(100*(f11 + f12)/2.0)))
                    c3 = c3 + 1
                    ...
                    c3 = c3 + 1
                    sh.write(index_excel, c3, int(n_clf))
        ...
        r1 = r1 + 1
        sh.write(r1, c1, "Prametri utilizzati: percentage=" + str(max_perc) + " e num. classificatori=" + str(max_n_clf))
        r1 = r1 + 1
